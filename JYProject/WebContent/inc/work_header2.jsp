	...
	<div id="header">
		...
		<div class="jyp_top" style="z-index:1000">
			...
			<a href="<%=request.getContextPath()%>/mypage_view.members">
				<img src="${pageContext.request.contextPath}/upload/${jyp_profile}" alt="마이페이지" style="width:80px;" title="${jyp_profile}"></a>
			</div>
			</div> </div>
		...
		<nav class="jyp_left" style="z-index:1000">	
			<h2 class="myhidden">주메뉴</h2>
			    <ul>
			      ...
			      <li><a href="<%=request.getContextPath()%>/calendar.cal"
			   ...
			   <%--    <li><a href="<%=request.getContextPath()%>/project/p_home.jsp"  --%>
			      ...
			      <li><a href="<%=request.getContextPath()%>/chat_home.chat"

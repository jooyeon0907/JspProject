				...
				<%-- 	<input type="text"  id="jyp_email"  name="jyp_email"  value="${jyp_email}" placeholder="이메일을 입력해주세요."  class="form-control"/> --%>
					<c:choose>
						...
						<c:otherwise>
							...
							<div class="idCheck_r" style="color:red; padding-left: 19px;"><!-- 중복검사결과 나오는 곳 --></div>
						</c:otherwise>
					</c:choose>

...
<script>
	...
	function getAddr() {
		...
		jQuery.ajax({
			...
			, data : {
				  ...
				  confmKey : "devU01TX0FVVEgyMDIwMDgxNzAwNDEzODExMDA3MTI="
	...
	<div id="wrap">
		...
		<span id="closeBtn" class="glyphicon glyphicon-remove" onClick="addressWindowClose();" title="닫기"></span>
		<div>
	...
	<button id="addBtn" class="btn btn-info">등록하기</button>
	...
	<script>
		$(function(){
			...
			$("#addBtn").click(function(){
				if($("#address").val()=="" || $("#detail").val()==""){alert('주소를 입력해주세요'); return false;}
				
				
				var address1 = $("#address").val();
				var address2 = $("#detail").val();
				 $.ajax({
					 url:"${pageContext.request.contextPath}/ws_address.ws",   
						type:"get", 
						dataType :"text",   
						...
						//	alert(result);
							if(result.trim()=="성공"){
								alert('주소등록완료');
								location.href='${pageContext.request.contextPath}/ws_edit_view.ws?ws_no='+${ws_no};

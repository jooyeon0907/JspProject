...
<!DOCTYPE html>
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body" style="padding:40px 50px;">
		        	<strong style="color:red">'${ws_name}' 워크스페이스를 탈퇴하겠습니까?</strong>
								
 		          <form action="${pageContext.request.contextPath}/ws_Memdelete.ws" method="post"> 
 		          	<fieldset>
	...
	<!-- 	            <div class="form-group">
		            ...
		            <div class="form-group">
		             ...
		             <button type="submit" class="btn mybtn btn-danger form-control" id="btn_del">삭제하기</button> -->

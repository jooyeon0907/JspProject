...
public class Paging_WS_DTO {
	...
	public ArrayList<JYP_WS_DTO> getList() {
		return list;
	}
	public void setList(ArrayList<JYP_WS_DTO> list) {
		this.list = list;
	}
	public Paging_WS_DTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Paging_WS_DTO(int pageTotal, int onepageLimit, int pageAll, int pstartNo, int bottomList, int bottom_current,
			int bottom_start, int bottom_end, ArrayList<JYP_WS_DTO> list) {
		super();
		this.pageTotal = pageTotal;
		this.onepageLimit = onepageLimit;
		this.pageAll = pageAll;

...
public class Paging_File_DTO {
	...
	public ArrayList<P_Work_DTO> getList() {
		return list;
	}
	public void setList(ArrayList<P_Work_DTO> list) {
		this.list = list;
	}
	public Paging_File_DTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Paging_File_DTO(int pageTotal, int onepageLimit, int pageAll, int pstartNo, int bottomList, int bottom_current,
			int bottom_start, int bottom_end, ArrayList<P_Work_DTO> list) {
		super();
		this.pageTotal = pageTotal;
		this.onepageLimit = onepageLimit;
		this.pageAll = pageAll;

...
public class Paging_Invi_DTO {
	...
	ArrayList<WS_Invitation_DTO> list;
	...
	public ArrayList<WS_Invitation_DTO> getList() {
		return list;
	}
	public void setList(ArrayList<WS_Invitation_DTO> list) {
		this.list = list;
	}
	public Paging_Invi_DTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Paging_Invi_DTO(int pageTotal, int onepageLimit, int pageAll, int pstartNo, int bottomList, int bottom_current,
			int bottom_start, int bottom_end, ArrayList<WS_Invitation_DTO> list) {
		super();
		this.pageTotal = pageTotal;
		this.onepageLimit = onepageLimit;
		this.pageAll = pageAll;
